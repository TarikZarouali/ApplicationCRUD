...
<div class="container container-mvckdemo">
    <div class="wrapper-mvckdemo">
        <div class="form-group">
            <h2>Maken nieuwe Sollicitatie</h2>
            <form id="CreateSollicitatie" method="POST" action="<?= URLROOT; ?>/Sollicitatie/create" autocomplete="on">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" class="input-field-error-message" name="Bedrijfnaam" required="true"
                        maxlength="50" value="<?= $data->Bedrijfnaam ?>">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" style="width:11.7rem; class=" input-field-error-message" name="Bedrijfcode"
                        required="true" maxlength="10" value="<?= $data->Bedrijfcode ?>">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" class="input-field-error-message" name="Straat" required="true" maxlength="50"
                        value="<?= $data->Straat ?>">
                ...
                <div class="form-group row">
                    ...
                    <input type="number" class="input-field-error-message" name="Huisnummer" required="true"
                ...
                <div class="form-group row">
                    ...
                    <input type="text" class="input-field-error-message" name="Toevoeging" maxlength="10"
                ...
                <div class="form-group row">
                    ...
                    <input type="text" class="input-field-error-message" name="Postcode" required="true" maxlength="10"
                        value="<?= $data->Postcode ?>">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" class="input-field-error-message" name="Plaats" required="true" maxlength="50"
                        value="<?= $data->Plaats ?>">
                ...
                <div class="form-group row">
                    ...
                    <input type="date" class="input-field-error-message" name="Gespreksdatum" required="true"
                        value="<?= $data->Gespreksdatum ?>"></input>
                    <span class="invalidFeedback"><?= $data->GespreksdatumError ?></span>
                </div>

                <div class="form-group row">
                    <label class="col-sm-3 control-label">Gesprekstijd *</label>
                    <input type="Time" class="input-field-error-message" name="Gesprekstijd" required="true"
                        value="<?= $data->Gesprekstijd ?>"></input>
